...
class JobDAO:
    ...
    @db_safe
    def save_job_stub(self, db, job_data: JobStubCreate) -> JobResponse:
    ...
    @db_safe
    def save_job_details(self, db, job_details: JobDetailsCreate) -> JobResponse:
    ...
    @db_safe
    def save_job_form_fields(self, db, external_id: int, fields_data: List[JobFormFieldCreate]) -> JobResponse:
    ...
    @db_safe
    def claim_job_for_processing(self, db, current_status: JobStatus, new_status: JobStatus) -> JobResponse:
    ...
    @db_safe
    def update_job_status(self, db, external_id: int, new_status: JobStatus) -> JobResponse:
        job = self._get_stub_by_external_id(db, external_id)
        if not job:
    ...
    @db_safe
    def get_job_details(self, db, job_id: int) -> JobDetails | None:
